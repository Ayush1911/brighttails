                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var article = _filteredEvents![index];
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Image.network(
                                  img + article["article_image_1"].toString(),
