...
import 'package:brighttails/doctor/DoctorDetails.dart';
...
class _DoctorPageState extends State<DoctorPage> {
  ...
  void filterEvents(String query) {
    final filtered = _allEvents?.where((event) {
      final category = event["doctor_name"].toString().toLowerCase();
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var doctor = _filteredEvents![index];
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    img + doctor["doctor_image"].toString(),
                                    width: double.infinity,
