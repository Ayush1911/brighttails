...
class _BrandpageState extends State<Brandpage> {
  ...
  Future<List<dynamic>?> getdata() async {
    Uri url = Uri.parse(UrlRescource.ALLBRAND);
  ...
  void filterEvents(String query) {
    final filtered = _allEvents?.where((event) {
      final category = event["brand_name"].toString().toLowerCase();
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var Brand = _filteredEvents![index];
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => Brandproduct(
                                GetData: Brand["brand_id"],
                              ),
                            ),
                          );
                        },
